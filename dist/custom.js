jQuery(document).ready(function($) {
    $(".flyout-form-overlay .frm_forms .frm_form_fields .frm_form_field .frm_checkbox input[type=checkbox], .contact-form .frm_forms .frm_form_fields .frm_form_field .frm_checkbox input[type=checkbox]").on("click", function(e){
        ...
        _this.parents().siblings(".frm_checkbox").find("input[type='checkbox']").prop('checked', false);
    ...
    countelem.each(function(){
        ...
        selectId.change(function(){
            ...
            var callLabel1 = 'Schedule a call with a ' + selectedOption1 + ' specialist';
            $('#frm_checkbox_41-0 label span').html(callLabel1);
            var appointmentLabel1 = 'Schedule a ' + selectedOption1 + ' service appointment';
            $('#frm_checkbox_41-1 label span').html(appointmentLabel1);
        });
    });

        const checkField = $(".contact-form .frm_forms .frm_form_fields #frm_checkbox_8-1 input[type='checkbox']");
        ...
        $('.contact-form select#field_rfh74').change(function() {
            ...
            var appointmentLabel = 'Schedule a ' + selectedOption + ' service appointment';
