jQuery(document).ready(function ($) {
  ...
  if ($(window).width() >= 1024) {
    ...
    $('.p-slick-dot[data-slide="0"]').addClass(
    ...
    psliderFor.on(
      ...
      function (event, slick, currentSlide, nextSlide) {
        var directionClass =
          nextSlide > currentSlide ? 'moveRightSlide' : 'moveLeftSlide'
        $('.p-slick-dot[data-slide="' + nextSlide + '"]')
    ...
    psliderFor.on(
      'afterChange',
      function (event, slick, currentSlide, slickNext) {
        $('.p-slick-dot').removeClass('slick-current')
        $('.p-slick-dot[data-slide="' + currentSlide + '"]').addClass(
          'slick-current',
        )
        $('.process-num').fadeIn(1000)
        $('.p-slick-dot[data-slide="' + currentSlide + '"]')
          .find('.process-num')
          .fadeOut(1000)
      },
    )
